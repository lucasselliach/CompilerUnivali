    ...
    public void sintaicoClick() {
        ...
        jTextArea2.setText("Analisando...    \n ");
         try{
                ...
                for (String listaAssembly: semantico.getListaAssemblyVar()) { 
                    if(listaAssembly.equalsIgnoreCase("@")){
                        pulalinha = false;
                    }else{
                        if(pulalinha){
                            jTextArea2.setText(jTextArea2.getText() + "\n" + listaAssembly);
                            ...
                            pulalinha = true;
                            jTextArea2.setText(jTextArea2.getText() + listaAssembly);
                        }
                    }
                }
                
                for (String listaAssembly: semantico.getListaAssembly()) { 
                    if(listaAssembly.equalsIgnoreCase("@")){
                        pulalinha = false;
                    }else{
                        if(pulalinha){
